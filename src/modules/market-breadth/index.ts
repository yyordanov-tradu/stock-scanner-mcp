    ...
    tools: [
      {
        ...
        inputSchema: z.object({
          universe: z.enum(["major_us", "NYSE", "NASDAQ", "AMEX"]).default("major_us")
            .describe("Stock exchange universe. major_us includes NYSE, NASDAQ, and AMEX. NYSE, NASDAQ, or AMEX queries single exchange."),
