    ...
    tools: [
      ...
      },
      {
        ...
        inputSchema: z.object({
          ...
          workflowCadence: z.enum(["daily", "weekly"]).optional().describe("How often you review the market"),
        }),
        readOnly: false,
        openWorld: false,
      ...
      },
      {
        ...
        inputSchema: z.object({
          symbol: z.string().max(50).describe("The raw symbol (e.g., 'AAPL')"),
          summary: z.string().max(5000).describe("Brief summary of your investment view"),
          bullCase: z.string().max(2000).optional().describe("Arguments for price going up"),
          bearCase: z.string().max(2000).optional().describe("Arguments for price going down"),
          catalyst: z.string().max(2000).optional().describe("Upcoming events that might move the price"),
          timeframe: z.string().max(100).optional().describe("Investment horizon (e.g., '3-6 months')"),
        }),
        readOnly: false,
        openWorld: false,
